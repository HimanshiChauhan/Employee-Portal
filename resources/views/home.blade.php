                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('job-form') }}">
                        ...
                        <div class="form-group row">
                            <label for="job_title" class="col-md-4 col-form-label text-md-right">{{ __('Title') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="job_location" class="col-md-4 col-form-label text-md-right">{{ __('Location') }}</label>
